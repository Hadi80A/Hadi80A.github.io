...
function datePickerClosed(dateField)
{
  if (dateField.name.substring(0,5) == "FDate") {
	var sPath = window.location.pathname;
	//var sPage = sPath.substring(sPath.lastIndexOf('\\') + 1);
	var sPage = sPath.substring(sPath.lastIndexOf('/') + 1);
	document.location = sPage+'?'+dateField.name+'='+dateField.value;
  }
}
...
var PERSIAN_WEEKDAYS = new Array("ļæ½ļæ½ļæ½ļæ½ļæ½", "ļæ½ļæ½ļæ½ļæ½ļæ½ļæ½",
